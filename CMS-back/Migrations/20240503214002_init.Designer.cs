...
{
    [DbContext(typeof(Data_Access_Layer.Data.CMSContext))]
    [Migration("20240503214002_init")]
    partial class init
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMS_back.Models.Control_Text", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CMS_back.Models.StudentSubject", b =>
                {
            ...
            modelBuilder.Entity("CMS_back.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("CMS_back.Models.Control", "MemberOfControl")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("CMS_back.Models.Control", b =>
                {
                    b.HasOne("CMS_back.Models.ApplicationUser", "ControlManager")
            ...
            modelBuilder.Entity("CMS_back.Models.Subject", b =>
                {
                    b.HasOne("CMS_back.Models.Faculity_Phases", "Faculity_Phases")
                        .WithMany("Subjects")
                        .HasForeignKey("Faculity_PhasesID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CMS_back.Models.Faculity_Semester", "Faculity_Semester")
                        .WithMany("Subjects")
