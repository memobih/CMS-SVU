...
namespace CMS_back.Services
{
    public class UserRepository : IUserRepository
    {
        ...
        public UserRepository(CMSContext _context, UserManager<ApplicationUser> _userManager,
            IHttpContextAccessor _contextAccessor,IGenericRepository<Faculity> _facultyRepository,
            IMapper _mapper, IGenericRepository<ControlUsers> controlUsersRepository)
        {
            context=_context;
            ...
            _controlUsersRepository=controlUsersRepository;
        }
